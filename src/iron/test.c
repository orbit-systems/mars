...
void test_algsimp_reassoc() {
    ...
    fe_set_func_params(f, 1, fe_type(m, FE_I64));
    fe_set_func_returns(f, 1, fe_type(m, FE_I64));
...
void test_c_gen() {
    ...
    FeFunction* f = fe_new_function(m, sym);
    fe_set_func_params(f, 2, fe_type(m, FE_I64), fe_type(m, FE_I64));
    fe_set_func_returns(f, 2, fe_type(m, FE_I64), fe_type(m, FE_I64));
